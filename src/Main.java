...
public class Main {
           ...
           while (opcio !=5){       //mientras no sea 5
               ...
               switch (opcio) {
                   ...
                   case 5:
                       ...
                       break;
                   case 6:
                       controlador.mostrarTotsElsContactes();
                       break;
                   default:
                       tui.println("");
                       break;
    ...
    public static void cercarContacte(TUI tui, Controlador controlador, Scanner sc) {
        ...
        if (opcioCerca == 1) { // ID
            ...
            int id = sc.nextInt();
            Contacte contacte = controlador.cercarContactePerId(id);  //si el id existe el m. devuelve el objeto contacte
            ...
            switch (opcioCerca) {
                case 2: // Nom
                    ...
                    List<Contacte> Nom = controlador.cercarContactePerNom(valor[0]);
                ...
                case 3: // Cognoms
                    camp = "cognoms";
                    valor = tui.demanarDadaCercaContacte(camp);
                    List<Contacte>  Cognoms= controlador.cercarContactePerCognoms(valor[0]);
                ...
                case 4: // Telèfon
                    camp = "telefon";
                    valor = tui.demanarDadaCercaContacte(camp);
                    List<Contacte>  Telefon= controlador.cercarContactePerTelefon(valor[0]);
                ...
                case 5: // Email
                    camp = "email";
                    valor = tui.demanarDadaCercaContacte(camp);
                    List<Contacte>  Email= controlador.cercarContactePerEmail(valor[0]);
